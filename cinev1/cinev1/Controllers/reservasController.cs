...
namespace cinev1.Controllers
{
    public class reservasController : Controller
    {
        ...
        {
            var reserva = db.reserva.Include(r => r.cliente).Include(r => r.proyeccion).Include(r => r.proyeccion1).Include(r => r.sala).Include(r => r.sala1).Include(r => r.sala2);
